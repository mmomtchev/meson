...
#define SWIGTYPE_p_Pi swig_types[0]
...
Napi::Value piAsync(const Napi::CallbackInfo &info);

    double placeholder() { return 0.0; };
...
// js_global_declaration
Napi::Value _wrap_placeholderAsync(const Napi::CallbackInfo &info);
// js_global_declaration
Napi::Value _wrap_placeholderSync(const Napi::CallbackInfo &info);

SWIGINTERN
int SWIG_AsVal_int (Napi::Value valRef, int* val);

// js_global_declaration
Napi::Value _wrap_calcAsync(const Napi::CallbackInfo &info);
// js_global_declaration
Napi::Value _wrap_calcSync(const Napi::CallbackInfo &info);

#define SWIG_NAPI_INIT example_initialize


// jsnapi_class_prologue_template
template <typename SWIG_OBJ_WRAP>
class _exports_Pi_templ : public SWIG_NAPI_ObjectWrap_templ<SWIG_OBJ_WRAP> {
public:
  _exports_Pi_templ(const Napi::CallbackInfo &);
_exports_Pi_templ(bool, const Napi::CallbackInfo &);
// jsnapi_class_method_declaration
Napi::Value _wrap_new_Pi(const Napi::CallbackInfo &);
// jsnapi_class_method_declaration
Napi::Value _wrap_Pi_approxAsync(const Napi::CallbackInfo &);
// jsnapi_class_method_declaration
Napi::Value _wrap_Pi_approxSync(const Napi::CallbackInfo &);
virtual ~_exports_Pi_templ();
// jsnapi_class_epilogue_template
};
// jsnapi_class_instance
class _exports_Pi_inst : public _exports_Pi_templ<_exports_Pi_inst> {
public:
  using _exports_Pi_templ::_exports_Pi_templ;
  virtual ~_exports_Pi_inst() = default;
  static void GetMembers(
    Napi::Env,
    std::map<std::string, _exports_Pi_templ::PropertyDescriptor> &,
    std::map<std::string, _exports_Pi_templ::PropertyDescriptor> &
    );
  static Napi::Function GetClass(Napi::Env);
};
...
:SWIG_NAPI_ObjectWrap_templ<SWIG_OBJ_WRAP>(true, info) {
  ...
  try {
    ...
    if(static_cast<int>(info.Length()) < 1 || static_cast<int>(info.Length()) > 1) {
      SWIG_Error(SWIG_ERROR, "Illegal number of arguments for _wrap_new_Pi.");
    }
...
// js_function_async
template <typename SWIG_OBJ_WRAP>
Napi::Value _exports_Pi_templ<SWIG_OBJ_WRAP>::_wrap_Pi_approxAsync(const Napi::CallbackInfo &info) {
  // js_async_worker_local_class
  class _exports_Pi__wrap_Pi_approxAsync_Tasklet : public SWIG_NAPI_AsyncContext {
    Napi::Env env;
    Pi *arg1 = (Pi *) 0 ;
    void *argp1 = 0 ;
    int res1 = 0 ;
...
#undef SWIG_NAPI_Raise
  ...
  if(static_cast<int>(info.Length()) < 0 || static_cast<int>(info.Length()) > 0) {
    SWIG_Error(SWIG_ERROR, "Illegal number of arguments for _wrap_Pi_approxAsync.");
  }
  context = new _exports_Pi__wrap_Pi_approxAsync_Tasklet(env);
  worker = new SWIG_NAPI_AsyncWorker(
    env, "SWIG__exports_Pi__wrap_Pi_approxAsync_Async_Worker", context);
...
// js_function
template <typename SWIG_OBJ_WRAP>
Napi::Value _exports_Pi_templ<SWIG_OBJ_WRAP>::_wrap_Pi_approxSync(const Napi::CallbackInfo &info) {
  Napi::Env env = info.Env();
  Napi::Value jsresult;
  Pi *arg1 = (Pi *) 0 ;
  void *argp1 = 0 ;
...
// js_dtoroverride
template <typename SWIG_OBJ_WRAP>
_exports_Pi_templ<SWIG_OBJ_WRAP>::~_exports_Pi_templ() {
  this->SWIG_Finalize();
  auto arg1 = reinterpret_cast<Pi *>(this->self);
  if (this->owned && arg1) {
    delete arg1;
    this->self = SWIG_NULLPTR;
  }
...
#undef SWIG_NAPI_Raise
  ...
  SWIG_NAPI_AsyncWorker *worker = SWIG_NULLPTR;
  if(static_cast<int>(info.Length()) < 0 || static_cast<int>(info.Length()) > 0) {
    SWIG_Error(SWIG_ERROR, "Illegal number of arguments for _wrap_placeholderAsync.");
  }
  context = new __wrap_placeholderAsync_Tasklet(env);
  worker = new SWIG_NAPI_AsyncWorker(
    env, "SWIG__wrap_placeholderAsync_Async_Worker", context);
  return worker->Run(info);
#ifndef NAPI_CPP_EXCEPTIONS
  goto fail;
fail:
...
Napi::Value _wrap_calcAsync(const Napi::CallbackInfo &info) {
  // js_async_worker_local_class
  class _exports_Pi__wrap_calcAsync_Tasklet : public SWIG_NAPI_AsyncContext {
    Napi::Env env;
    Pi *arg1 = (Pi *) 0 ;
...
#undef SWIG_NAPI_Raise
  ...
  SWIG_NAPI_AsyncWorker *worker = SWIG_NULLPTR;
  if(static_cast<int>(info.Length()) < 1 || static_cast<int>(info.Length()) > 1) {
    SWIG_Error(SWIG_ERROR, "Illegal number of arguments for _wrap_calcAsync.");
  }
  context = new _exports_Pi__wrap_calcAsync_Tasklet(env);
  worker = new SWIG_NAPI_AsyncWorker(
    env, "SWIG__wrap_calcAsync_Async_Worker", context);
  return worker->Run(info);
#ifndef NAPI_CPP_EXCEPTIONS
  goto fail;
fail:
...
SWIGINTERN swig_type_info _swigt__p_Pi = {"_p_Pi", "p_Pi|Pi *", 0, 0, (void*)0, 0};
...
SWIGINTERN swig_cast_info _swigc__p_Pi[] = {  {&_swigt__p_Pi, 0, 0, 0},{0, 0, 0, 0}};
...
SWIGINTERN swig_type_info *swig_types[4];
SWIGINTERN swig_module_info swig_module = {swig_types, 3, 0, 0, 0, 0};
...
void _exports_Pi_inst::GetMembers(
  Napi::Env env,
  std::map<std::string, _exports_Pi_templ::PropertyDescriptor> &members,
  std::map<std::string, _exports_Pi_templ::PropertyDescriptor> &staticMembers
  ) {
  ...
  members.insert({
    "approxAsync",
      _exports_Pi_templ::InstanceMethod("approxAsync",
        &_exports_Pi_templ::_wrap_Pi_approxAsync,
        static_cast<napi_property_attributes>(napi_writable | napi_configurable))
    });
  // jsnapi_register_member_function
  members.erase("approxSync");
  members.insert({
    "approxSync",
      _exports_Pi_templ::InstanceMethod("approxSync",
...
Napi::Function _exports_Pi_ctor = _exports_Pi_inst::GetClass(env);
exports.Set("Pi", _exports_Pi_ctor);
if (SWIGTYPE_p_Pi->clientdata == SWIG_NULLPTR) {
  SWIGTYPE_p_Pi->clientdata = new size_t(0);
}
Napi::FunctionReference *_exports_Pi_ctor_ref = new Napi::FunctionReference();
*_exports_Pi_ctor_ref = Napi::Persistent(_exports_Pi_ctor);
env.GetInstanceData<EnvInstanceData>()->ctor[0] = _exports_Pi_ctor_ref;
...
do {
  Napi::Value protoBase, protoSub;
  NAPI_CHECK_RESULT(_exports_Pi_ctor.Get("prototype"), protoSub);
  NAPI_CHECK_RESULT(SWIG_NAPI_ObjectWrap_ctor.Get("prototype"), protoBase);
  NAPI_CHECK_MAYBE(setProto.Call({
    _exports_Pi_ctor, SWIG_NAPI_ObjectWrap_ctor
  }));
  NAPI_CHECK_MAYBE(setProto.Call({
    protoSub, protoBase
  }));
...
do {
  Napi::PropertyDescriptor pd = Napi::PropertyDescriptor::Function("piAsync", piAsync,
    static_cast<napi_property_attributes>(napi_writable | napi_enumerable | napi_configurable));
  NAPI_CHECK_MAYBE(exports.DefineProperty(pd));
} while (0);
// jsnapi_register_global_function
do {
  Napi::PropertyDescriptor pd = Napi::PropertyDescriptor::Function("placeholderAsync", _wrap_placeholderAsync,
    static_cast<napi_property_attributes>(napi_writable | napi_enumerable | napi_configurable));
  NAPI_CHECK_MAYBE(exports.DefineProperty(pd));
} while (0);
// jsnapi_register_global_function
do {
  Napi::PropertyDescriptor pd = Napi::PropertyDescriptor::Function("placeholderSync", _wrap_placeholderSync,
    static_cast<napi_property_attributes>(napi_writable | napi_enumerable | napi_configurable));
  NAPI_CHECK_MAYBE(exports.DefineProperty(pd));
} while (0);
// jsnapi_register_global_function
do {
  Napi::PropertyDescriptor pd = Napi::PropertyDescriptor::Function("calcAsync", _wrap_calcAsync,
    static_cast<napi_property_attributes>(napi_writable | napi_enumerable | napi_configurable));
  NAPI_CHECK_MAYBE(exports.DefineProperty(pd));
} while (0);
// jsnapi_register_global_function
do {
  Napi::PropertyDescriptor pd = Napi::PropertyDescriptor::Function("calcSync", _wrap_calcSync,
    static_cast<napi_property_attributes>(napi_writable | napi_enumerable | napi_configurable));
  NAPI_CHECK_MAYBE(exports.DefineProperty(pd));
} while (0);
